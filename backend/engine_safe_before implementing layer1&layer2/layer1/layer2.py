...
_STAGE1_SYSTEM = """You are an expert Indian Chartered Accountant reviewing a taxpayer profile for FY 2024-25.
...
- 80EEB: EV loan interest (max ₹1.5L). Loan sanctioned 1-Apr-2019 to 31-Mar-2023 from bank/NBFC for electric vehicle.
- 80EEA: Affordable housing extra interest (max ₹1.5L). Stamp duty ≤ ₹45L, loan 1-Apr-2019 to 31-Mar-2022, first home buyer only.
...
_STAGE2_SYSTEM = """You are an Indian tax eligibility verifier for FY 2024-25 / AY 2025-26.
  ...
  "resolved_deductions": [
    {
      ...
      "conditions_unverified": ["Loan sanction date — must be 1-Apr-2019 to 31-Mar-2023"],
      "conditions_failed": [],
