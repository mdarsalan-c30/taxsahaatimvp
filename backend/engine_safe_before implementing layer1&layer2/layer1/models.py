...
- AY is fixed to 2025-26 (FY 2024-25).
"""
...
class SalaryInput:
    ...
    professional_tax: float = 0.0                            # Sec 16(iii), typically ₹2,400 p.a.
    ...
    employer_nps_contribution: float = 0.0                   # 80CCD(2), capped at 10% of basic
...
class CapitalGainsInput:
    ...
    stcg_other: float = 0.0   # debt MF etc. short-term → slab rate
    ltcg_other: float = 0.0   # debt/property etc. long-term → 20%
