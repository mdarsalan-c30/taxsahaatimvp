...
const WHY_ICONS = [
  // Checkmark / mismatch
  <svg key="1" width="20" height="20" viewBox="0 0 16 16" fill="none" aria-hidden><path d="M2 8l3 3 9-9" stroke="#1D4ED8" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"/></svg>,
  // Bar chart / regime
  <svg key="2" width="20" height="20" viewBox="0 0 16 16" fill="none" aria-hidden><path d="M2 12V4M6 12V7M10 12V2M14 12V9" stroke="#1D4ED8" strokeWidth="1.6" strokeLinecap="round"/></svg>,
  // Document / companion
  <svg key="3" width="20" height="20" viewBox="0 0 16 16" fill="none" aria-hidden><rect x="2" y="3" width="12" height="10" rx="1.5" stroke="#1D4ED8" strokeWidth="1.6"/><path d="M5 6.5h6M5 9h4" stroke="#1D4ED8" strokeWidth="1.4" strokeLinecap="round"/></svg>,
];
      ...
      <div className="mx-auto w-full max-w-[1180px]">
        ...
        <ScrollReveal delay={2} className="text-center">
          <Link
            ...
            className="inline-flex items-center gap-1.5 text-[15px] font-semibold text-[#1D4ED8] hover:underline group"
          >
            ...
            <svg width="14" height="14" viewBox="0 0 16 16" fill="none" aria-hidden className="transition-transform group-hover:translate-x-0.5">
              <path d="M3 8h10M9 4l4 4-4 4" stroke="#1D4ED8" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          </Link>
        </ScrollReveal>
      </div>
